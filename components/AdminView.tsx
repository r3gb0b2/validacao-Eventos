    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gray-800 p-5 rounded-lg border border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {events.map(ev => (
                                    <div key={ev.id} className="bg-gray-700/50 p-4 rounded border border-gray-600 hover:border-orange-500/50 transition-all flex justify-between items-center">
            ...
            case 'operators':
                ...
                return (
                    <div className="space-y-6 animate-fade-in">
                        <div className="bg-gray-800 p-10 rounded-2xl border border-gray-700 shadow-2xl flex flex-col items-center text-center">
                            <div className="bg-orange-600/20 p-6 rounded-full mb-6">
                                <VideoCameraIcon className="w-16 h-16 text-orange-500" />
                            </div>
                            <h2 className="text-3xl font-bold mb-2">Monitoramento de Operadores</h2>
                            <p className="text-gray-400 max-w-lg mb-8">
                                Acesse o painel externo para visualizar estatísticas detalhadas de cada portaria, taxa de falhas e duplicados em tempo real.
                            </p>
                            
                            <div className="w-full max-w-xl bg-gray-900 border border-gray-700 p-4 rounded-xl mb-6 font-mono text-sm break-all text-orange-300">
                                {operatorMonitorUrl}
                            </div>
                            ...
                            <div className="flex gap-4">
                                <button 
                                    ...
                                    className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-xl flex items-center transition-all"
                                >
                                ...
                                <a 
                                    ...
                                    className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-xl flex items-center transition-all"
                                >
                        ...
                        <div className="bg-orange-600/10 border border-orange-500/20 p-6 rounded-xl text-orange-200">
                            <h4 className="font-bold flex items-center mb-2">
                                <AlertTriangleIcon className="w-4 h-4 mr-2" />
                                Dica de Uso
                            </h4>
                            <p className="text-sm">
                                Este link é público e pode ser enviado para supervisores de portaria acompanharem a produtividade sem precisar de login administrativo.
                            </p>
                        </div>
                    </div>
                );
